...
```text
hse_recsys_rnn/
  artifacts/      # метрики, summary-таблицы, графики и небольшие checkpoint-файлы
...
Большие промежуточные parquet-таблицы, сырые логи, системные кэши и временные smoke-embeddings не входят в git. В репозитории сохранены финальные метрики, графики, конфигурации, небольшие checkpoint-файлы, ноутбуки и отчет, то есть все материалы, необходимые для проверки выводов.
